/* eslint-disable no-extend-native, max-params, complexity */
...
Date.prototype.AREDate = function (
  country, timeLimitValue, timeLimitTypeParam, adminAllowanceValue, adminAllowanceTypeParam) {
  ...
  const timeLimitType = timeLimitTypeParam.replace(/ /g, '');
  const adminAllowanceType = adminAllowanceTypeParam.replace(/ /g, '');
