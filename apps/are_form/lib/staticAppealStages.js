  ...
  getstaticAppealStages: function() {
   ...
   return [
      { 'value': 'FT_IC',
        ...
        'start-date-label': 'Date Refusal letter sent by HO',
      ...
      { 'value': 'FT_OOC_1',
        ...
        'start-date-label': 'Appellants date of departure',
        'rules': 'The Tribunal Procedure (First-tier tribunal) (Immigration and Asylum Chamber) Rules 2014',
        'ruleNumber': '19(3)(a)',
      ...
      { 'value': 'FT_OOC_2',
        ...
        'timeLimit': {'value': 28, 'type': 'calendar'},
        'start-date-label': 'Date of receipt of the Refusal letter',
        'rules': 'The Tribunal Procedure (First-tier tribunal) (Immigration and Asylum Chamber) Rules 2014',
        'ruleNumber': '19(3)(b)',
        'adminAllowance': {'value': 1, 'type': 'working'},
        'country': 'All',
      ...
      { 'value': 'FT_IC_FAST',
        ...
        'start-date-label': 'Start Date (tbc)',
      ...
      { 'value': 'FT_UT_IC',
        ...
        'timeLimit': {'value': 14, 'type': 'calendar'},
        'start-date-label': 'Date written reasons for the decision sent',
        'rules': 'The Tribunal Procedure (First-tier tribunal) (Immigration and Asylum Chamber) Rules 2014',
        'ruleNumber': '33(2)',
        'adminAllowance': {'value': 1, 'type': 'working'},
        'country': 'All',
